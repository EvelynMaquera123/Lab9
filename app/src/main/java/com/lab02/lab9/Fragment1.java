...
public class Fragment1 extends Fragment implements  FragmentCallbacks{
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        EditText editMsg=view.findViewById(R.id.name);
        Button btnClickme=view.findViewById(R.id.send);
        btnClickme.setOnClickListener( new View.OnClickListener()
        {
            ...
            public void onClick(View view) {
                ...
                mainCallbacks.onMSGFromFragToMain("FR2",message);
            }
        });
    ...
    public void onAttach(Context context){
        ...
        if(context instanceof  MainCallbacks){
            ...
            throw new RuntimeException(context.toString()+"must implements Fragment Calllbacks");
        }
    }
    @Override
